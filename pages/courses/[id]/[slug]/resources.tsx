...
import requireEnrollmentMiddleware from '@/middleware/requireEnrollmentMiddleware'
...
const Resources = (props: any) => {
  ...
  return (
    <>
    {/* <CourseLayout topics={topics} course={course}> */}
      <Container mb={200} p={0}>
        <Stack p={0}>
          <Title ta='center' mx="auto">Resources</Title>
